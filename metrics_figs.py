...
thresholds = range(250, 951, 10)  # From 800 to 950 in 10-point steps
precisions = []
automation_rates = []
recalls = []
f1_scores = []
...
plt.plot(thresholds, f1_scores, label='F1 Score', marker='D', linestyle=':', markersize=3)
# plt.plot(thresholds, accuracies, label='Accuracy', marker='v', linestyle='-', markersize=2)
...
plt.ylim(0.92, 1.02)  # Add some padding above 1
...
#         print(f"{threshold}: Precision={precisions[idx]:.3f}, Automation Rate={automation_rates[idx]:.3f}")